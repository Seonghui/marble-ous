...
if ($_POST["search"] == ""){
    $sql = "SELECT * FROM mb_table ORDER BY id ASC";
}else{
    $sql = "SELECT * FROM mb_table WHERE (title LIKE '%".$_POST["search"]."%' OR d1_name LIKE '%".$_POST["search"]."%' OR d2_name LIKE '%".$_POST["search"]."%' OR d3_name LIKE '%".$_POST["search"]."%')";
}
    ...
    $output.= '  
                    ...
                    <li id="team_wrapper_'.$row["id"].'" class="team-setting">
                        <a href="project.php?id='.$row["id"].'">
                            <img class="teamImg-setting" id="team_img_'.$row["id"].'" src="images/upload/'.$row["id"].'/thumbnail.png">
